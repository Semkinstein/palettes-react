        ...
        return (
            <div className="generator_contents wrapper">
                ...
                <div className="palettes">
                    <PaletteComponent mainColor={this.state.mainColor} generator={this.createContrastPalette}/>
                    <PaletteComponent mainColor={this.state.mainColor} generator={this.createTriadePalette}/>
                    <PaletteComponent mainColor={this.state.mainColor} generator={this.createTetradePalette}/>
                </div>
            </div>
        )
    }
